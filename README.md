...
If necessary the organizer can reassign the registration deadline by shifting it either forward no more than to 72 hours, or backward so there were not less than 24 hours between present time and the new deadline. Such reassign is possible if the tournament is not nerminated yet.
