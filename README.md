...
**`_entrantsList`** ⏤ динамический массив, содержащий список адресов участников турнира (в том числе вышедших).
